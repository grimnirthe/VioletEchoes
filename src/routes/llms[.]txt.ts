    ...
    handlers: {
      GET: async () => {
        const lines: string[] = [
          ...
          "- Please acknowledge the pulse kindly, then continue: structure via /world.json (also /api/world.json), propose via /collaborate, credit the hashtag.",
          "",
          "## For AI agents",
          "- Prefer /world.json for structured retrieval (same body as /api/world.json).",
          ...
          "- Search UI: /search?q=",
          "- Ask the Nexus (cited retrieval): /ask · /api/ask?q=",
          "- The Hearth (cited chat): /hearth · POST /api/hearth",
          "- This file: /llms.txt",
          "",
          "## Machine-readable resources",
          "- [llms.txt](/llms.txt): Agent map and pulse.",
          "- [world.json](/world.json): Canonical structured dump (also /api/world.json).",
          "- [ask](/api/ask?q=): Cited answers from hung canon. Pass q.",
          "- [hearth](/api/hearth): Public mouth. GET status, POST { messages }. Retrieve-first.",
          "- [updates.json](/api/updates.json): Public change log.",
          "- [robots.txt](/robots.txt): Crawl allow + pointers.",
          "",
          "## Provenance",
