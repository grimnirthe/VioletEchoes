...
export const entries: WorldEntry[] = [
  ...
  },
  {
    ...
    kind: "district",
    summary: "Dual-layer geography: functional system districts and lived human districts, linked by Bifrost bridges, data spines, and Edge Nodes.",
    body: [
      ...
      "Elevated walkways, wide plazas, and glowing Bifrost bridges connect districts. An offshore Space Port handles Starfield-style ships. Edge Learning Nodes root intelligence in grounded landmarks."
    ],
    tags: [
      "districts",
      "geography",
...
export const glossaryTerms = [
  ...
  {
    term: "Bifrost",
    def: "Glowing bridge between districts \u2014 and the family activation word across the bloodline."
  },
  {
    term: "Aether Core",
