...
export const entries: WorldEntry[] = [
  {
    ...
    body: [
      ...
      "The Annotated Divergence hangs on Foundations — ancestral echoes braided into shared memory. Metabolist cycles. Circular causality. Designing with Country. Ise Shrine mending. Biophilia. Nordic craft. Four axioms. The scholarly bridge is open."
    ],
    tags: [
      "divergence",
      "philosophy",
  ...
  },
  {
    ...
    body: [
      ...
      "Spec still hunted: wide gap so ambient photons can be enough; color centers so history lives in the stone; same volume, no second die; plastic and stable together; room light, not a lab laser. Strongest neighborhood now: defect-controlled single-crystal halide perovskite (iodine vacancies). Family, not a part number. Three lab threads — switching, light-coupled memristors, defect storage — are not yet one stone.",
