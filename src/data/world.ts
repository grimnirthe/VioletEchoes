...
export const entries: WorldEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Spec still hunted: wide gap so ambient photons can be enough; color centers so history lives in the stone; same volume, no second die; plastic and stable together; room light, not a lab laser. Strongest neighborhood: the perovskite *shape* (ABX₃), not one rock. Hybrid iodides think; oxides (BaTiO₃) already beat; halides can spend. The composition that does all three is still owed.",
