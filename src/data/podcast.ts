...
export const podcastMeta = {
  ...
  body: [
    ...
    "Audio deep dives + Gemini Notebook video overviews. Roots spoken series #001–#006 live. Visual foundations, rain-lit tour, Dual-Layer cultural dive, Hearthrow Dual-Layer portal hung.",
  ],
