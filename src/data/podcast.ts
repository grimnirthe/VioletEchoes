...
export const podcastMeta = {
  ...
  body: [
    ...
    "Audio deep dives + Gemini Notebook video overviews. Roots spoken series #001–#006 live. Visual foundations, rain-lit tour, Dual-Layer cultural dive, Hearthrow Dual-Layer portal, Innovation shop-floor, Neon Core skyline, Thornwall Old Iron walk hung.",
  ],
...
export const videoOverviews: VideoOverview[] = [
  ...
  },
  {
    ...
    related: [
      ...
      { label: "Neon Core skyline walk", href: "/podcast#v010-neon-core-skyline" },
  ...
  {
    id: "v010-neon-core-skyline",
    title: "Violet Echoes: Neon Core — skyline walk",
    series: "Visual · District portals · Neon Core",
    date: "2026-08-12",
    durationHint: "~8.5 min",
    summary:
      "Skyline door. New Atlantis lines over Nordic Longhouse soul. Divergence as a civilizational choice — coherence, energy, local, memory, cultivation. Innovation without cost is illusion. Eimyrja recommends, does not command. What world would we choose to carry?",
    videoSrc: "/video/010-neon-core-skyline.mp4",
    posterSrc: "/images/video/010-neon-core-skyline-poster.jpg",
    related: [
      { label: "Neon Core Lore Guide", href: "/bible/companions/neon-core-guide" },
      { label: "Neon Core", href: "/bible/neon-core" },
      { label: "City · Skyline", href: "/city#neon-core" },
      { label: "Innovation shop-floor walk", href: "/podcast#v009-innovation-shop-floor" },
      { label: "Hearthrow portal", href: "/podcast#v008-hearthrow-dual-layer" },
      { label: "Thornwall Old Iron walk", href: "/podcast#v011-thornwall-old-iron" },
      { label: "Districts deck", href: "/bible/districts" },
      { label: "Tenets", href: "/bible/the-tenets" },
    ],
    by: "Gemini Notebook · Loom · hearth",
  ...
  {
    id: "v011-thornwall-old-iron",
    title: "Violet Echoes: Metropolis — Old Iron walk",
    series: "Visual · District portals · Thornwall",
    date: "2026-08-12",
    durationHint: "~9 min",
    summary:
      "Industrial anchor. Night City grit against New Atlantis lines, Nordic Longhouse soul. Divergence as a civilizational choice. Five tenets. Dual-layer city. Local adaptation — Old Iron bones turned sanctuary. Eimyrja recommends. What will you choose to carry?",
    videoSrc: "/video/011-thornwall-old-iron.mp4",
    posterSrc: "/images/video/011-thornwall-old-iron-poster.jpg",
    related: [
      { label: "Old Iron Codex", href: "/bible/companions/thornwall-codex" },
      { label: "Thornwall", href: "/bible/thornwall" },
