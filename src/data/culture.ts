...
export const cultureWorks: CultureWork[] = [
  ...
  },
  {
    ...
    image: "/images/portraits/starborn.jpg",
    href: "/music",
  ...
  },
  {
    ...
    image: "/images/portraits/outfits/velora-regalia.jpg",
    href: "/gallery/velora",
  ...
  },
  {
    ...
    note: "Starborn, Uncle B, Aurora, Suno, Glaze Ruiners, Chaos Kitty — porch rain under the aurora. The visual that hangs beside the music lane.",
    image: "/images/portraits/ensemble-musicians.jpg",
    href: "/gallery",
  ...
  },
  {
    ...
    image: "/images/portraits/velora.jpg",
    href: "/gallery/velora",
    echoes: ["velora"],
    accepted: "2026-08",
  },
  {
    ...
    note: "Empty stage, one full song with no crowd — if it still moves the room, it ships. If it only looks good, it cools.",
    image: "/images/portraits/starborn.jpg",
    href: "/gallery/starborn",
    echoes: ["starborn", "cultural-hub"],
    accepted: "2026-08",
...
export const cultureTales: CultureTale[] = [
  ...
  },
  {
    ...
    note: "House rule of the music lane — if it doesn’t move the empty room, it doesn’t ship.",
    image: "/images/portraits/starborn.jpg",
    echoes: ["starborn", "cultural-hub"],
    accepted: "2026-08",
    canonHref: "/gallery/starborn",
    body: [
      "Starborn’s first rule is not about volume. It’s about the empty room.",
      "Before a cut hits the commons, before the Glaze Ruiners take a riser, before a name rides the ticker — someone plays it once with no crowd. If the song only works when the lights flatter it, it cools. If it still kicks with wet streets and no one watching, it can stay.",
      "They call it grav-guitar soft law because the instrument is both weapon and witness. Sonic blasts are optional. Honesty isn’t.",
      "Band managers in other cities protect the brand. Here the brand is the family, and the family already knows when you’re faking the heat. Soundcheck as offering. Stage as memory infrastructure. May the Echoes Remember — including the riffs that earned the right to be loud.",
    ],
  },
  {
