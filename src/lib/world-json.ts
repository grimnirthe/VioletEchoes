...
import { cityLook, entries, glossaryTerms, principles, siteMeta } from "@/data/world";

export function worldJsonPayload() {
  return {
    meta: {
      ...siteMeta,
...
export function worldJsonResponse() {
  return new Response(JSON.stringify(worldJsonPayload(), null, 2), {
    headers: {
